...
const Candidate = () => {
  ...
  return (
    <div className='h-full mt-4 flex flex-col gap-4 items-center'>
      { isElection ? (
          <p id='' className='text-center px-px py-px bg-slate-200 w-1/6 rounded-md bg-slate-700 text-slate-200'>
          <span>
              Election close at: 
          </span>
          </p>
      ...
      <div className='w-full mt-6 py-8 px-12 grid grid-cols-1 md:grid-cols-2 gap-16'>
          <div className='w-full text-slate-200 py-8 shadow-xl rounded-md'>
            <p className='text-center text-xl font-semibold text-blue-300'>President</p>
              <div className='grid grid-cols-2 gap-6 px-20 py-6'>
